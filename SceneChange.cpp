...
void SceneChange::Update()
{
    ...
    if (frameCount_current % frameTarget_interval == 0 && seqOrderFinished != 1)
    {
        ...
        {
            rows_buffer = sequentialOrder[seqOrderIndex] / 16;
            cols_buffer = sequentialOrder[seqOrderIndex] % 16;
            tileFlapped[rows_buffer][cols_buffer] = 1;
    ...
    {
        if (constantT_open[rows_buffer][cols_buffer] == 1.0f)
        {
            seqOrderFinished = 1;
